...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.5rem;">
    ...
    <div>
    {% include card_flip.html item="Viridian Deceiver" content="Rarity: Uncommon <br> Base: Polearm <br> Component: Poison Gland [Hydra] <br> Time: 20 Hours <br><br> <a href="{% www.google.com %}">link test</a> <br>" url="https://github.com/Npjthomas/The_Imperium/blob/main/items/Card_Viridian_Deceiver.png?raw=true" %} 
    </div>

...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.5rem;">
    ...
    <div>
    {% include card_flip.html item="Viridian Deceiver" content="Rarity: Uncommon [Upgradable]<br> Base: Polearm <br> Component: Poison Gland [Hydra] <br> Time: 20 Hours  <br><br>This polearm embodies the treacherous, deceitful essence of the Hydra. Foul poison drips from its curved, bronze blade, warning that beneath its beautiful surface, this weapon is just as dangerous and deadly as it is elegant." url="https://github.com/Npjthomas/The_Imperium/blob/main/items/Card_Viridian_Deceiver.png?raw=true" %} 
    </div>
    <div>
    {% include card_flip.html item="Lernaean_Pendant" content="Rarity: Uncommon [Upgradable] <br> Base: Pendant <br> Component: Pouch of Scales [Hydra] <br> Time: 20 Hours  <br><br>Although the serpentine heads adorning this necklace are capable of movement, they prefer to remain unsettlingly still, only occasionally blinking their gemstone eyes. The only exception occurs if an open flame is brought close to the pendant, which causes the hydra heads to hiss angrily and recoil from the flames." url="https://github.com/Npjthomas/The_Imperium/blob/main/items/Card_Lernaean_Pendant.png?raw=true" %} 
    </div>
    <div>

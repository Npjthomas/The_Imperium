...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.5rem;">
    ...
    <div>
    {% include card_flip.html item="Viridian Deceiver" content="Rarity: Uncommon <br> Base: Polearm  <br> Component: Poison Gland [Hydra] <br> Time: 20 Hours <br><br> This polearm embodies the treacherous, deceitful essence of the Hydra. Foul poison drips from its curved,
